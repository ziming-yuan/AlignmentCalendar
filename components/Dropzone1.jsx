...
export default function Dropzone({ defaultImageUrl, name }) {
    ...
    const [ogFileDelted, setOgFileDeleted] = useState(false);
    ...
    return (
        <>
            ...
            <input
                type="hidden"
                name={`${name}-fileUpdated`}
                value={fileUpdated}
            />
            <input
                type="hidden"
                name={`${name}-ogFileDelted`}
                value={ogFileDelted}
            />
            <div
                role="presentation"
